...
export default tseslint.config(
  {
    ignores: [
      ...
      'node_modules/**',
      '.vite/**',
      // The native projects are generated by `npx cap add` and contain a copy of
      // the built web bundle (`ios/App/App/public`, `android/app/src/main/assets/public`).
      // None of it is ours to lint (Milestone 9, docs/DEVICE.md).
      'ios/**',
      'android/**',
    ],
  },
